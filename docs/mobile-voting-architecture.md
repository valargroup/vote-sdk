...
See [Gov Steps V1](https://github.com/z-cale/shielded-vote/blob/main/docs/gov-steps-v1.md) for the cryptographic protocol spec. See the [Figma board](https://www.figma.com/board/CCKJMV6iozvYV8mT6H050a/Wallet-SDK-V2) for UI design.
