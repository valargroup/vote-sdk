...
// SlashingKeeper defines the slashing module interface needed by the vote module
// for setting JailedUntil on ceremony-jailed validators so that the standard
// cosmos.slashing.v1beta1.MsgUnjail flow works.
