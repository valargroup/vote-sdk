            ...
            <div className="divide-y divide-border-subtle">
              {rows.map((r) => (
                ...
                >
                  ...
                  <div className="grid min-w-0 gap-3 px-3 pb-3 pt-0 sm:py-3 lg:grid-cols-[minmax(90px,0.65fr)_minmax(130px,0.78fr)_minmax(0,1.3fr)_minmax(0,1.05fr)] lg:items-center">
                    ...
                    <div className="min-w-0">
                      <div className="mb-1 text-[10px] uppercase tracking-wider text-text-muted">Requested</div>
                      <div className="text-text-secondary break-words">
                        {formatUnix(r.requested_at)}
                      </div>
                    </div>
