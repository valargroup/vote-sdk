...
type VoteRound struct {
	...
	CeremonyPayloads     []*DealerPayload      `protobuf:"bytes,17,rep,name=ceremony_payloads,json=ceremonyPayloads,proto3" json:"ceremony_payloads,omitempty"`
	CeremonyAcks         []*AckEntry           `protobuf:"bytes,18,rep,name=ceremony_acks,json=ceremonyAcks,proto3" json:"ceremony_acks,omitempty"`
	CeremonyDealer       string                `protobuf:"bytes,19,opt,name=ceremony_dealer,json=ceremonyDealer,proto3" json:"ceremony_dealer,omitempty"`
...
const file_svote_v1_types_proto_rawDesc = "" +
	...
	"\aoptions\x18\x04 \x03(\v2\x14.svote.v1.VoteOptionR\aoptions\"\xef\t\n" +
	"\tVoteRound\x12\"\n" +
	...
	"\x13ceremony_validators\x18\x10 \x03(\v2\x1c.svote.v1.ValidatorPallasKeyR\x12ceremonyValidators\x12D\n" +
	"\x11ceremony_payloads\x18\x11 \x03(\v2\x17.svote.v1.DealerPayloadR\x10ceremonyPayloads\x127\n" +
	"\rceremony_acks\x18\x12 \x03(\v2\x12.svote.v1.AckEntryR\fceremonyAcks\x12'\n" +
	"\x0fceremony_dealer\x18\x13 \x01(\tR\x0eceremonyDealer\x120\n" +
	...
	"\x11dkg_contributions\x18\x1c \x03(\v2\x19.svote.v1.DKGContributionR\x10dkgContributions\",\n" +
	...
	"roundTrees\x12S\n" +
	"\x13partial_decryptions\x18\r \x03(\v2\".svote.v1.GenesisPartialDecryptionR\x12partialDecryptions\"\xd6\x02\n" +
	...
	"\x04acks\x18\x05 \x03(\v2\x12.svote.v1.AckEntryR\x04acks\x12\x16\n" +
...
var file_svote_v1_types_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_svote_v1_types_proto_goTypes = []any{
	...
	(*GenesisPartialDecryption)(nil), // 12: svote.v1.GenesisPartialDecryption
	(*GenesisBlockLeafIndex)(nil),    // 13: svote.v1.GenesisBlockLeafIndex
	(*CommitmentLeaf)(nil),           // 14: svote.v1.CommitmentLeaf
	(*NullifierEntry)(nil),           // 15: svote.v1.NullifierEntry
	(*TallyResult)(nil),              // 16: svote.v1.TallyResult
	(*BlockCommitments)(nil),         // 17: svote.v1.BlockCommitments
	(*ProposalSummary)(nil),          // 18: svote.v1.ProposalSummary
	(*OptionSummary)(nil),            // 19: svote.v1.OptionSummary
	(*CeremonyState)(nil),            // 20: svote.v1.CeremonyState
	(*ValidatorPallasKey)(nil),       // 21: svote.v1.ValidatorPallasKey
	(*DKGContribution)(nil),          // 22: svote.v1.DKGContribution
	(*DealerPayload)(nil),            // 23: svote.v1.DealerPayload
	(*AckEntry)(nil),                 // 24: svote.v1.AckEntry
}
var file_svote_v1_types_proto_depIdxs = []int32{
	...
	21, // 4: svote.v1.VoteRound.ceremony_validators:type_name -> svote.v1.ValidatorPallasKey
	23, // 5: svote.v1.VoteRound.ceremony_payloads:type_name -> svote.v1.DealerPayload
	24, // 6: svote.v1.VoteRound.ceremony_acks:type_name -> svote.v1.AckEntry
	22, // 7: svote.v1.VoteRound.dkg_contributions:type_name -> svote.v1.DKGContribution
	4,  // 8: svote.v1.GenesisState.rounds:type_name -> svote.v1.VoteRound
	15, // 9: svote.v1.GenesisState.nullifiers:type_name -> svote.v1.NullifierEntry
	16, // 10: svote.v1.GenesisState.tally_results:type_name -> svote.v1.TallyResult
	21, // 11: svote.v1.GenesisState.pallas_keys:type_name -> svote.v1.ValidatorPallasKey
	10, // 12: svote.v1.GenesisState.tally_accumulators:type_name -> svote.v1.GenesisTallyAccumulator
	11, // 13: svote.v1.GenesisState.share_counts:type_name -> svote.v1.GenesisShareCount
	8,  // 14: svote.v1.GenesisState.round_trees:type_name -> svote.v1.GenesisRoundTree
	12, // 15: svote.v1.GenesisState.partial_decryptions:type_name -> svote.v1.GenesisPartialDecryption
	6,  // 16: svote.v1.GenesisRoundTree.tree_state:type_name -> svote.v1.CommitmentTreeState
	14, // 17: svote.v1.GenesisRoundTree.commitment_leaves:type_name -> svote.v1.CommitmentLeaf
	9,  // 18: svote.v1.GenesisRoundTree.commitment_roots:type_name -> svote.v1.GenesisCommitmentRoot
	13, // 19: svote.v1.GenesisRoundTree.block_leaf_indices:type_name -> svote.v1.GenesisBlockLeafIndex
	19, // 20: svote.v1.ProposalSummary.options:type_name -> svote.v1.OptionSummary
	1,  // 21: svote.v1.CeremonyState.status:type_name -> svote.v1.CeremonyStatus
	21, // 22: svote.v1.CeremonyState.validators:type_name -> svote.v1.ValidatorPallasKey
	23, // 23: svote.v1.CeremonyState.payloads:type_name -> svote.v1.DealerPayload
	24, // 24: svote.v1.CeremonyState.acks:type_name -> svote.v1.AckEntry
	23, // 25: svote.v1.DKGContribution.payloads:type_name -> svote.v1.DealerPayload
