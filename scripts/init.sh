...
HELPER_MAX_CONCURRENT_PROOFS_V3="${SVOTE_HELPER_MAX_CONCURRENT_PROOFS_V3:-2}"
...
# Maximum concurrent proof generation goroutines. The v3 key resets upgraded
# validators to two workers; the binary ignores the legacy unversioned/v2 keys.
max_concurrent_proofs_v3 = $HELPER_MAX_CONCURRENT_PROOFS_V3
