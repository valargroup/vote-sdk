...
export function buildHandoffMessage({
  ...
  return [
    "Please add me as a Shielded Vote manager.",
    "",
    "On-chain vote-manager address, for the chain coordinator policy vote_manager_addresses:",
    sv1Address,
    "",
  ...
  return JSON.stringify(
    {
      ...
      alg: "ed25519",
      pubkey: publicKeyB64,
      notes: `Vote-manager Keplr-derived key for ${sourceAddress}`,
    },
    null,
    2
  );
