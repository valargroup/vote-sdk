...
import (
	...
	"github.com/valargroup/vote-sdk/x/slashing"
...
func TestBeginBlocker(t *testing.T) {
	...
	msg, err := stakingtypes.NewMsgCreateValidator(addr.String(), pk, sdk.NewCoin(bondDenom, amt), description, commission, math.OneInt())
	require.NoError(t, err)
